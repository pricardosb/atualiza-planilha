...
if 'arquivo_atualizado_pronto' not in st.session_state:
...
if df_origem is not None and wb_data is not None:
    ...
    if st.button("🚀 Processar e Atualizar"):
        ...
        # Sincroniza o estado para as demais opções/downloads
        st.session_state["wb_data"] = buffer.getvalue()
        st.session_state['arquivo_atualizado_pronto'] = buffer.getvalue()

        st.success("✅ Processamento concluído com sucesso!")
        st.download_button("📥 Baixar Arquivo Atualizado", st.session_state['arquivo_atualizado_pronto'], "destino_atualizado.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
